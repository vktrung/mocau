...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/products/revenue-growth": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved revenue growth statistics",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/common.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.RevenueGrowth"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.TopSellingProduct"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "model.RevenueGrowth": {
            ...
            "properties": {
                "current_month": {
                    "description": "Revenue of current month (VND)",
                    "type": "number",
                    "example": 50000000
                },
                "growth_amount": {
                    "description": "Absolute growth amount (VND)",
                    "type": "number",
                    "example": 10000000
                },
                "growth_direction": {
                ...
                "previous_month": {
                    "description": "Revenue of previous month (VND)",
                    "type": "number",
                    "example": 40000000
                }
            }
